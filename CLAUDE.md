  ...
  "foods": [
    {
      ...
      "nutrition": { "calories": 650, "protein": 35, "carbs": 70, "fat": 22, "addedSugar": 3 }, // any/all optional; addedSugar shown as "Sugar (added)"
...
`addedSugar` is shown in the food detail view only — deliberately excluded
from the Planner's running totals/macro bars (explicit user ask).
